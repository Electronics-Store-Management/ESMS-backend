...
//    @NotAudited
    ...
    public ProductEntity(String id , String name, CategoryEntity category, String unit, Long price, Integer quantity, Integer warrantyPeriod, Boolean isAvailable, String photoURL){
        this.setId(id);
        this.name = name;
