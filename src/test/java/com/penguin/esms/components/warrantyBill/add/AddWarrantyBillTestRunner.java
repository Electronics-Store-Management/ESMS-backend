package com.penguin.esms.components.warrantyBill.add;
...
class AddWarrantyBillTestRunner {
    ...
    @Autowired
    public AddWarrantyBillTestRunner(MockMvc mockMvc, ObjectMapper objectMapper, CustomerRepo customerRepo, StaffRepository staffRepository, ProductRepo productRepo, TestService testService) {
    ...
    @Test
    public void shouldCreateWarrantyBill() throws Exception {
