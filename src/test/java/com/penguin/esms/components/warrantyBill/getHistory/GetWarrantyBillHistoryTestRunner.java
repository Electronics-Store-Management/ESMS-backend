package com.penguin.esms.components.warrantyBill.getHistory;
...
class GetWarrantyBillHistoryTestRunner {
    ...
    @Autowired
    public GetWarrantyBillHistoryTestRunner(MockMvc mockMvc, ObjectMapper objectMapper, CustomerRepo customerRepo, StaffRepository staffRepository, ProductRepo productRepo, TestService testService) {
    ...
    @Test
    public void shouldGetWarrantyBillHistory() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/warranty/history?start=1708677423693&end=" + new Date().getTime())
