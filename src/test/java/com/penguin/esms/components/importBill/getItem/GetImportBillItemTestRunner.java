package com.penguin.esms.components.importBill.getItem;
...
class GetImportBillItemTestRunner {
    ...
    private ImportBillEntity importBillEntity = new ImportBillEntity();
    ...
    @Test
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/import/" + importBillEntity.getId())
