package com.penguin.esms.components.saleBill.getItem;
...
class GetImportBillItemTestRunner {
    ...
    private SaleBillEntity saleBillEntity = new SaleBillEntity();
    ...
    @Test
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/sale/" + saleBillEntity.getId())
