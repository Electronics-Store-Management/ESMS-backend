package com.penguin.esms.components.saleBill.add;
...
class AddSaleBillTestRunner {
    ...
    @Autowired
    public AddSaleBillTestRunner(MockMvc mockMvc, ObjectMapper objectMapper, CustomerRepo customerRepo, StaffRepository staffRepository, ProductRepo productRepo, TestService testService) {
    ...
    @Test
    public void shouldCreateSaleBill() throws Exception {
